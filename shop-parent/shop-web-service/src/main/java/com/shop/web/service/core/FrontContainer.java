package com.shop.web.service.core;
...
//	public static IndexImgService indexImgService;// 门户滚动图片
	...
	// @Deprecated
	// public static String show_user_option_error =
	// "show_user_option_error";//显示用户操作错误信息，error.jsp页面会显示session中该key指定的错误信息，显示后会同时清除该错误信息。
	// 当前门户上的菜单
