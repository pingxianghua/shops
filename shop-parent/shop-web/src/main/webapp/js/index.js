...
$(document).ready(function() {
	...
	$(".SZY-SEARCH-BOX-HELPER .clear").click(function() {
		var url = 'clear-record.html'/*tpa=http://www.szy.yunmall.68mall.com/search/clear-record.html*/;
...
function search_box_remove(key) {
	var url = 'delete-record.html'/*tpa=http://www.szy.yunmall.68mall.com/search/delete-record.html*/;
	$.post(url, {
		data: key
	}, function(result) {
		if (result.code == 0) {
